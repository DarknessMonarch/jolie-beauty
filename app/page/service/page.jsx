  ...
  return (
    ...
    <Image
      ...
      <div className={styles.serviceContainer}>
        ...
        <div className={`${styles.serviceCard} ${index % 2 === 0 ? styles.evenCard : styles.oddCard}`} key={index}>
            ...
            {service.button === "Coming soon" ? (
              ...
              <button className={styles.serviceButton} onClick={getAppointment}>
                {service.button}
              </button>
            )}
            </div>
